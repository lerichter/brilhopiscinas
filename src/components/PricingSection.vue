                ...
                <div class="flex-center">
                  <v-card-text>
                    <div class="flex-center">
                      <div class="circle1">
                        <div class="circle2">
                          <v-img src="~@/assets/img/limpeza-de-piscina.svg"></v-img>
                        </div>
                      </div>
                    </div>
                    <div class="text--disabled text-uppercase text-h5 my-2">Limpeza Avulsa</div>
                    <v-divider class="my-2"/>
                    <div class="text-uppercase blue--text">Incluso produtos</div>
                    <v-divider class="my-2"/>
                    ...
                    <!-- <v-btn
                        ...
                        color="blue"
                        class="mt-6"
                        href="https://api.whatsapp.com/send?phone=5511999395160"
                        target="_blank"
                    >
                       em Contato!
                    </v-btn> -->
                ...
                <div class="flex-center">
                  <v-card-text>
                    <div class="flex-center">
                      <div class="circle1">
                        <div class="circle2">
                          <v-img src="~@/assets/img/limpeza-de-piscina.svg"/>
                        </div>
                      </div>
                    </div>
                    <div class="text--disabled text-uppercase text-h5 my-2">Limpeza Mensal</div>
                    <v-divider class="my-2"/>
                    <div class="text-uppercase blue--text">Incluso produtos</div>
                    <v-divider class="my-2"/>
              ...
              <v-col class="col-12 col-md-4">
                ...
                <div class="flex-center">
                  <v-card-text>
                    ...
                    <div class="text--disabled text-uppercase text-h5 my-2">Troca de Vinil</div>
                    <v-divider class="my-2"/>
                    <div class="text-uppercase blue--text">Mão de obra especializada</div>
                    <v-divider class="my-2"/>
                    <div class="text-uppercase blue--text">com garantia</div>
                    <v-divider class="my-2"/>
